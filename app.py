...
st.set_page_config(page_title="Iris Project - Shivani")

# Add a title in browsers body
st.title("Iris End to End Project - Shivani Jagtap")

# Take sepal lenght , sepal width, petal lenght, petal width as input
...
pet_len = st.number_input("Petal Lenght : ",min_value=0.00, step=0.01)
...
def predict_species(pre_path, model_path):
    #Get the input in dataframe format
...
# Predicting result on the web app after submit is pressed
if submit:
    # Get pre path and model path
    pre_path = 'notebook/preprocessor.pkl'
    model_path = 'notebook/model.pkl'
    #get the prediction along with probability
